...
const story = 
{
    "0":{
                            ...
                            "1":{
                                ...
                                "1":{
                                    ...
                                    "1":{
                                        ...
                                        "1":{
                                            a:"Ваш друг детектива начал подходить к дому, но не заметил вас. Поговорить с ним?",
                                            b:0,
                                            c:["0","1"],
                                            "0":{
                                                a:"",
        ...
        "9":{
            a:"Прошло 2 недели. К вам в дом стучатся полицейские и сообщают, что вы подозреваетесь в похощении детей.",
            b:-1,
            c:["2"],
...
const storyMissions = 
{
    "1":{
        a:"Разгадайте ребус.",
        b:["письмо","письма"],
        p:"937455/a0f4d8f32811eafbbdba",
    },
    "2":{
        a:"Разгадайте ребус.",
        b:["сообщество","сообщетсва"],
        p:"1540737/ba7fd8f208e76a8f3c14",
    },
    "3":{
        a:"\nРешите задачу:\nКаждую субботу четверо друзей мылись в бане. Петр, музыкант, всегда брал с собой плейер, чтобы слушать музыку. Александр, банкир, приносил с собой термос с каким-нибудь напитком. Федр и Павел были адвокатами и всякий раз брали с собой бумаги, чтобы почитать. Однажды Павла нашли мертвым в парилке. Он был убит каким-то острым предметом. Сразу же вызвали полицию. Полицейские допросили всех троих подозреваемых, однако, зацепок не нашли. Что же произошло?",
        b:["убил_александр","убить_александр"],
        p:"",
    },
    "4":{
        a:"Разгадайте ребус.",
        b:["загадка","загадки"],
        p:"1540737/d1b9dc2315ed9daaf44d",
    },
    "6":{
        a:"Найдите сумму всех цифр на картинке.",
        b:["45"],
        p:"997614/8304920f6692ffe1b816",
    },
    "8":{
        a:"Найдите неизвестное число.",
        b:["3"],
        p:"213044/c13037d4c2bbc6a6f62c",
    },
    "12":{
        a:"Разгадайте ребус",
        b:["известие","известия"],
        p:"997614/28415d52552d8ed4d173",
    },
...
const server = micro(async (req, res) => { 
    ...
    if (session["new"]){
        sessionState.isArcade = false;
        sessionState.isStory =false;
        sessionState.quests = {};
        sessionState.difficulty = "";
        sessionState.questionNum = 1;
        sessionState.questionNum2 = 0;
        sessionState.travel = "0";
        sessionState.storyQuest = -1;
...
const PORT = 3000;
server.listen(PORT, () => console.log(`слушай, ${PORT}`));